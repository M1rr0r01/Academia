 ...
 <div class="todos">  
    ...
    <div class="col row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td><th><a href="RegistroDeNotasinsert.php?idAlumno=<?php echo $mostrar['idAlumno']?>" class="btn btn-info">Registrar</a></th></td>
            ...
            <a align="right" href="ModificarNotas.php"><p align="right"> <input  type="buton" class="btn btn-outline-dark" value="siguiente" /></p> </a>
        </div>
        <br>
