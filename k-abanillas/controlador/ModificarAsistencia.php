...
<?php include("VerificarT.php")?> 
    ...
    <h1>Modificar Asistencia</h1>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <?php
		                    ...
		                    $sql="SELECT CodAsistencia, CodAlumno, NombreCompleto, Fecha, Estado, Justificacion, idAlumno FROM Home_Alumno, Home_asistencia";
		                    $resultado=mysqli_query($conexion,$sql);
                            $row=mysqli_fetch_array($resultado);
                            while($row=mysqli_fetch_array($resultado)){
                                if($row['CodAsistencia']==$row['idAlumno']){
                            
                            
                        ?>
                        
                    <tr>
                        <td><input  style="width:15px" type="text" value="<?php echo $row['CodAsistencia']?>"></td>
                        ...
                        <td><th><a href="modificarAsistenciaupdate.php?CodAsistencia=<?php echo $row['CodAsistencia']?>" class="btn btn-info">Editar</a></th></td>
                    </tr>
                </tbody>
                <?php   
                    }
        ...
        <a align="right" href="InformeDeAsitencia.php"><p align="right"> <input  type="buton" class="btn btn-outline-dark" value="siguiente" /></p> </a>
