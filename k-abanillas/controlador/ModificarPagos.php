    ...
    <h1 >Modificar pagos</h1>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                <?php
		                $sql="SELECT CodPagos, idAlumno, CodAlumno, NombreCompleto, CodPags,Fecha,monto,Descripcion,Tipopag FROM Home_Alumno, Home_Pagos";
		                $resultado=mysqli_query($conexion,$sql);
		                while($mostrar=mysqli_fetch_array($resultado)){
                            if($mostrar['CodPagos']==$mostrar['idAlumno']){
		                ?>
                    <tr>
                        <td><?php echo $mostrar['CodPagos']?></td>
                        <td><?php echo $mostrar['NombreCompleto']?></td>
                        <td><?php echo $mostrar['CodPags']?></td>
                        <td> <?php echo $mostrar['Fecha']?></td>
                        <td>
                            <?php echo  "S/",$mostrar['monto']?>
                        </td>
                        ...
                        <td> 
                        <?php echo $mostrar['Tipopag']?>
                        </td>
                        <td><th><a href="ModificarPagosupdate.php?CodPagos=<?php echo $mostrar['CodPagos']?>" class="btn btn-info">Editar</a></th></td>
                    </tr>
                </tbody>
                <?php
                }
        ...
        <a align="right" href="ReportePagos.php"><p align="right"> <input  type="buton" class="btn btn-outline-dark" value="siguiente" /></p> </a>
    </div>
    </div>
</body>
</html>